...
# lst = ['무지','콘','어피치','제이지', '프로도','네오','튜브','라이언']
...
#             #current= lst[k]
#     elif i.startswith('Z'):
#         copy_deleted_lst = copy.deepcopy(deleted_lst)
#         lst.insert(copy_deleted_lst[-1][0],copy_deleted_lst[-1][1])
#         del deleted_lst[-1]
#         #current= lst[k]

# answer = ''
# for check in initial_lst:
#     if check in lst:
#         answer += '0'
#     else:
#         answer += 'X' 
